...
public class HomeControllerTest extends TestCase {
  ...
  public void testFurnitureGroup() {
    ...
    assertEquals("Surrounding group rectangle x is incorrect", rotatedGroupRectangle.getX(), groupRectangle.getX(), 0.0001);
    assertEquals("Surrounding group rectangle y is incorrect", rotatedGroupRectangle.getY(), groupRectangle.getY(), 0.0001);
    assertEquals("Surrounding group rectangle width is incorrect", rotatedGroupRectangle.getWidth(), groupRectangle.getWidth(), 0.0001);
    assertEquals("Surrounding group rectangle height is incorrect", rotatedGroupRectangle.getHeight(), groupRectangle.getHeight(), 0.0001);
